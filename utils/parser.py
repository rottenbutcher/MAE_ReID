...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true', 
        default=False, 
        help = 'Use viewpoint and random masking as data augmentation for supervised training')
    
    parser.add_argument(
        '--lr_finetune', 
        type=float, default=0.0001, 
        help = 'Learning rate for the second phase of fine-tuning after unfreezing.')
    parser.add_argument(
        '--unfreeze_threshold', 
        type=float, default=-1.0, 
        help = 'Accuracy threshold to unfreeze the encoder. -1 to disable.')
